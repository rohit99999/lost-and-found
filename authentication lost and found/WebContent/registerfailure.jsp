...
.signin {
 ...
 <label for="email"><b>Last Name</b></label>
    ...
    <input style="margin-left:14px" type="password" placeholder="Enter Password" name="pass" required><br>
    <p style="color:red;">Username already exist! please try with another Username.</p>
    <hr>
